...
# 所需要文件的网络位置（本地位置：/data3/data/data/neuro/spatial_memory_pipeline）：
# https://storage.googleapis.com/dm_spatial_memory_pipeline/trajectories.pickle
# https://storage.googleapis.com/dm_spatial_memory_pipeline/hd_stats.pickle
# https://storage.googleapis.com/dm_spatial_memory_pipeline/parameters.pickle
# https://storage.googleapis.com/dm_spatial_memory_pipeline/visual_inputs.pickle
