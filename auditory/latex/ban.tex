...
For the mel-frequency cepstral coefficient (MFCC) model, the MIR toolbox was used to extract multiple music-related features from the dataset (Lartillot et al., 2008).
...
\begin{IEEEbiography}[{\includegraphics[width=1in,height=1.25in,clip,keepaspectratio]{./Authors/HaidongWang.eps}}]{Haidong Wang}
