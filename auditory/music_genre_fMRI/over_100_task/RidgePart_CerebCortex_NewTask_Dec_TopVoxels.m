function RidgePart_CerebCortex_NewTask_Dec_TopVoxels(ID, Method, TargetTimeTrn,TargetTimeVal,Rep,VoxelInd)
%
...
% Select top voxels
respTrn_ROI = respTrn_ROI(:, VoxelInd);
respVal_ROI = respVal_ROI(:, VoxelInd);
...
save([SaveDir 'RidgeDecResult_TopVoxels_' Method '_' ID '_NewTask' num2str(Rep)], 'Result');
