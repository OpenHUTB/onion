function RidgePart_CerebCortex_NewTask_WithReg_All(ID,Method)
%
...
tpresp = [];
for Rep = 1:5
    load([SaveDir  'RidgeResult_WithReg_' Method '_' ID '_NewTask' num2str(Rep) '.mat'], 'Result');
...
save([SaveDir 'RidgeResult_WithReg_' Method '_' ID '_NewTask_All.mat'], 'Result', '-v7.3');
  
Ridge_FDRcorr_NewTask_WithReg(ID, Method)
