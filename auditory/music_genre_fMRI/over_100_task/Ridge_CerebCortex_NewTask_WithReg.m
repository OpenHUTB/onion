function Ridge_CerebCortex_NewTask_WithReg(ID, Method)
%
%Ridge regression analysis, using novel tasks
%with sensorimotor regressors
%
%Input:
...
for rr = 1:5
    RidgePart_CerebCortex_NewTask_WithReg(ID,Method, TargetTimeTrn{rr},TargetTimeVal{rr},rr)
end
