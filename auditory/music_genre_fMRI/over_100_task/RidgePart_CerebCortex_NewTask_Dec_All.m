function RidgePart_CerebCortex_NewTask_Dec_All(ID,Method)
%
...
tpstim = [];
for Rep = 1:5
    load([SaveDir  'RidgeDecResult_' Method '_' ID '_NewTask' num2str(Rep) '.mat'], 'Result');
...
save([SaveDir 'RidgeDecResult_' Method '_' ID '_NewTask_All.mat'], 'Result', '-v7.3');
