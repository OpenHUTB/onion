...
h = figure('units','normalized','outerposition',[0 0.5 1 0.5]); drawnow
...
% 导出pdf时，去除pdf白色边框
export_figure(h, fullfile(figs_dir, 'fig_3_c_d.pdf'));
...
h = figure('units','normalized','outerposition',[2/3 0 1/3 0.5]); hold on
...
export_figure(h, fullfile(figs_dir, 'fig_S12.pdf'));
