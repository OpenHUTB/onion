...
示例： 原始视频的路径、存储凝视覆盖视频的路径、tsv凝视数据存储的路径（就像convert_eyelink_to_cont那样处理一样）
  ./overlay_gaze_on_video  D:/data/neuro/movie/fg_av_ger_seg1.mkv  C:/buffer/fg_av_ger_seg1_et.mkv  /data2/whd/workspace/data/neuro/software/ds000113/sub-01/ses-movie/func/sub-01_ses-movie_task-movie_run-2_recording-eyegaze_physio.tsv
...
Example:
  ...
  示例： 原始视频的路径、存储凝视覆盖视频的路径、tsv凝视数据存储的路径（就像convert_eyelink_to_cont那样处理一样）
  ./overlay_gaze_on_video  D:/data/neuro/movie/fg_av_ger_seg1.mkv  C:/buffer/fg_av_ger_seg1_et.mkv  C:/buffer/sub-01_ses-movie_task-movie_run-2_recording-eyegaze_physio.tsv

  /data2/whd/workspace/data/neuro/movie/fg_av_ger_seg0.mkv  /data2/whd/workspace/sot/hart/result/gaze/fg_av_ger_seg0_et.mkv  /data2/whd/workspace/data/neuro/software/ds000113/sub-01/ses-movie/func/sub-01_ses-movie_task-movie_run-1_recording-eyegaze_physio.tsv
