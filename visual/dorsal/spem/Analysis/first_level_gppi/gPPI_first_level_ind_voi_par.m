...
% first-level gPPI analysis for left and right PPC seed regions
%-----------------------------------------------------------------------
...
% coordinates from several studies were averaged (results: -25, -60, 56; 24, -56, 47, s. Supplementary Table 1), then entered 
% --> go to nearest local maximum was selected in the GUI
% --> nearest maximum and distance were saved along with subject id to
% par_coordinates.txt in the project path
...
A = readtable('par_coordinates.txt');
