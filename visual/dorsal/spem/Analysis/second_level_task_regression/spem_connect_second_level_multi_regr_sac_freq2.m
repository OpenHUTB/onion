...
% second-level regression analysis: .2 Hz smooth pursuit and corresponding
% saccadic frequency values
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'your_results_path'};                % please customize to your individual results path
%%
matlabbatch{1}.spm.stats.factorial_design.des.mreg.scans = {'your_first_level_vector'}; % please customize to your vector of first level con_0001 contrast paths
...
%%
matlabbatch{1}.spm.stats.factorial_design.cov.cname = 'sac_freq_02';
