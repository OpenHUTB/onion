...
% second-level regression analysis: .4 Hz smooth pursuit and corresponding
...
%%
matlabbatch{1}.spm.stats.factorial_design.des.mreg.scans = {'your_first_level_vector'}; % please customize to your vector of first level con_0002 contrast paths
...
%%
matlabbatch{1}.spm.stats.factorial_design.cov.cname = 'sac_freq_04';
