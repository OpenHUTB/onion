...
% second-level t-test between .4 Hz smooth pursuit and .2 Hz smooth pursuit
%-----------------------------------------------------------------------
matlabbatch{1}.spm.stats.factorial_design.dir = {'your_results_path'};                % please customize to your individual results path
%%
matlabbatch{1}.spm.stats.factorial_design.des.t1.scans = {'your_first_level_vector'}; % please customize to your vector of first level con_0004 contrast paths
%%
